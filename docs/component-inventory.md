...
| ------------------ | ---------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| `Button`           | `Button.tsx`           | 1:2820, 1:1067, 1:1338, 1:1709  | `variant: primary \| primary-deep \| neutral \| surface \| paper \| ghost`; `size: md(48) \| lg(56)`; `fullWidth`; `leadingIcon` / `trailingIcon`       | default, hover*, focus*, disabled*            |
...
| `Icon`             | `Icon.tsx`             | COCO/Line/* exports             | `name: IconName` (32 icons); `size: 16 \| 18 \| 20 \| 24`; `currentColor`                                                                               | —                                             |
...
| `Badge`            | `Badge.tsx`            | 1:1348, 1:1370                  | `tone: info \| urgent \| success \| warning \| danger \| neutral \| outline`; `size: sm \| md`; `dot`                                                   | —                                             |
...
| `Dialog*`          | `Dialog.tsx`           | 1:1700, 1:1701, 1:2410          | Radix wrappers: `DialogContent size: sm(425) \| md(600) \| lg(700)`, `DialogHeader/Title/Description/Footer/Close`                                      | open / closed; focus trap, ESC, overlay click |
