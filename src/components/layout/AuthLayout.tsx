...
export function AuthLayout({ preview, children }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen items-stretch gap-6 bg-canvas p-6">
      ...
      <section className="min-h-auth-panel max-w-auth-card flex w-full flex-col items-center justify-between rounded-2xl bg-paper px-6 py-10 shadow-card sm:px-12 xl:px-[150px]">
        {children}
      </section>
